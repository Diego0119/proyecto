<footer class="bg-purple-900 text-white">
  <div class="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-md">
      <strong class="block text-center text-xl font-bold text-purple-300 sm:text-3xl">
      ...
      <form class="mt-6">
        <div class="relative max-w-lg">
          ...
          <input
            class="w-full rounded-full border-purple-600 bg-purple-700 p-4 pe-32 text-sm font-medium"
            id="email"
            type="email"
